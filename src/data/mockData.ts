...
/* Typed gradients for React Native LinearGradient */
...
export const stories: Story[] = [
  {
    ...
    author: currentUser,
    category: "fiction",
    coverGradient: gradients[0].join(","),
    mediaType: "text",
  ...
  },
  {
    ...
    author: currentUser,
    category: "sci-fi",
    coverGradient: gradients[1].join(","),
    mediaType: "audio",
    duration: "4:32",
  ...
  },
  {
    ...
    content:
      "She stood at the window, watching the city dissolve into silver threads...",
    excerpt:
    ...
    author: currentUser,
    category: "romance",
    coverGradient: gradients[2].join(","),
    mediaType: "video",
    duration: "6:15",
  ...
  },
  {
    ...
    author: currentUser,
    category: "fantasy",
    coverGradient: gradients[3].join(","),
    mediaType: "text",
  ...
  },
  {
    ...
    author: currentUser,
    category: "poetry",
    coverGradient: gradients[4].join(","),
    mediaType: "audio",
    duration: "3:18",
  ...
  },
  {
    ...
    author: currentUser,
    category: "mystery",
    coverGradient: gradients[5].join(","),
    mediaType: "text",
